                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('sex') is-invalid @enderror p-1" id="sex" class="form-control" name="sex" required autocomplete="sex" autofocus>
                                    <option class="form-control" disabled selected>Выберите ваш пол</option>
