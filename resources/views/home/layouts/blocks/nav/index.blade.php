        ...
        <div class="container"><a href="/" class="navbar-brand"><img src="{{asset('img/logo.svg')}}" alt="" class="img-fluid"></a>
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"> <a href="/" class="nav-link @if(Route::currentRouteName() == "home") active-color @endif">Главная</a></li>
                    <li class="nav-item"> <a href="{{route('works')}}" class="nav-link @if(Route::currentRouteName() == "works") active-color @endif">Работы</a></li>
                @if (Route::has('login'))
                    @auth
